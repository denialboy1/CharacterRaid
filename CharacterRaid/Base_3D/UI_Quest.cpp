...
void UI_Quest::Initialize()
{
	...
	buttonOK->OnClick = std::bind(&UI_Functions::ButtonQuestOK, std::ref(UI_Manager::Get().func), buttonOK);
	...
	buttonCancel->OnClick = std::bind(&UI_Functions::ButtonQuestCancel, std::ref(UI_Manager::Get().func), buttonCancel);
