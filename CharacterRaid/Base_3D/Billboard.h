...
public:
	...
	void Initialize(D3DXVECTOR3 _pos, D3DXVECTOR3 _size, int _frameX, int _frameY,bool _isYFix = false);
	void Destroy();
	void Update(D3DXVECTOR3 cameraPos);
	void Render();

	void SetTextureFrame();
	void SetVPos(D3DXVECTOR3 pos){ m_vPos = pos; }
...
public:
	...
	void SetTempX(float _tempX){ tempX = _tempX; }
